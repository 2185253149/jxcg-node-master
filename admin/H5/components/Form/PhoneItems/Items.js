(function (G) {
  window["components_Form_PhoneItems_Items"]({
  "component": true,
  "usingComponents": {
...
template:'#TEMPLATE_components_Form_PhoneItems_Items',
    ...
    methods: {
      init: function (models, value, readOnly,tips){
        ...
        for (var key in models) {
          ...
          if(G.platform === 'Web' && !model.style){
            ...
            if(/textarea|image|editor|table|model|form|map|anyselect|customer/.test(model.type)) model.style = 'width:90%;min-height:40px;height:auto;float:none;clear:both;';
          ...
          if(readOnly || model.readOnly){
            ...
            //   model.attr.style += ';height:inherit;'
            // }
          }
        ...
        this.setData({ tips_:tips,formitems: formitems, valueShow:[value], value: value, _readOnly: !!readOnly });
      },
      change: function (event) {
        ...
        if (formitems[index].rule && this._models && this._models[formitemId]) {
