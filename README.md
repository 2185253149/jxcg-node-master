...
查询数据列表
models.table_name.list(query,callback,args)
...
查询单个数据详情
models.table_name.find(query,callback,args)
//query为{id:1}
前端请求接口:
url:/api/model/table_name
method:GET
...
新增数据
models.table_name.insert(data,callback,args)
前端请求接口:
url:/api/model/table_name
method:POST
data:{}//对应data
...
修改数据
models.table_name.update(query,data,callback,args)
前端请求接口:
url:/api/model/table_name
method:PUT
...
删除数据
models.table_name.remove(query,callback,args)
